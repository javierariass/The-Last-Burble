...
public class SliderController : MonoBehaviour
{
    ...
    public float duration = 5f; // Duraci�n para ir de 0 a 100 y de 100 a 0
    private bool increasing = true; // Controla la direcci�n del slider
    public BattleController Bc;

    void Start()
    {
        hitBar.maxValue = 100f; // Establece el valor m�ximo del slider
